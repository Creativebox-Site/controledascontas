...
const steps = [
  {
    icon: Sparkles,
    title: 'Bem-vindo ao App Contas!',
    description: 'Seu assistente pessoal para controle financeiro inteligente',
    content: 'Gerencie suas finanças de forma simples e organizada. Vamos fazer um tour rápido pelas principais funcionalidades.',
    color: 'text-primary',
  ...
  },
  {
    ...
    content: 'Adicione suas transações rapidamente, categorize gastos e acompanhe para onde vai seu dinheiro. Use categorias personalizadas ou as que já criamos para você!',
  ...
  },
  {
    ...
    content: 'Já criamos categorias essenciais para você começar: Alimentação, Transporte, Moradia e muito mais. Personalize ou crie novas conforme sua necessidade.',
  ...
  },
  {
    ...
    content: 'Acompanhe tendências, identifique gastos excessivos e tome decisões informadas com gráficos detalhados e análises automáticas.',
    color: 'text-blue-500',
  ...
  },
  {
    ...
    content: 'Crie metas de economia, planeje aquela viagem dos sonhos ou junte para uma compra importante. Acompanhe o progresso em tempo real!',
  ...
  },
  {
    ...
    content: 'Configure lembretes para contas recorrentes, receba notificações antes do vencimento e mantenha suas contas em dia sem esforço.',
    color: 'text-rose-500',
