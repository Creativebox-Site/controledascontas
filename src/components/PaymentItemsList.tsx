...
import { Calendar, DollarSign, Bell, MoreVertical, Check } from "lucide-react";
...
interface PaymentItem {
  ...
  payment_reminders: { id: string }[];
}

export const PaymentItemsList = ({ userId, currency, refreshKey }: PaymentItemsListProps) => {
