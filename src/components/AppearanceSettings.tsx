...
export const AppearanceSettings = ({
  ...
  return <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-4">
            <Avatar className="h-20 w-20">
              {isEmoji ? <AvatarFallback className="text-4xl bg-muted">
                  {avatarUrl}
                </AvatarFallback> : <AvatarImage src={avatarUrl} alt="Avatar" />}
            </Avatar>
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                ...
                <Button variant="outline" size="sm" onClick={() => setEmojiPickerOpen(true)}>
      ...
      <AvatarImageEditor open={imageEditorOpen} onClose={() => {
      setImageEditorOpen(false);
      setTempImageUrl(null);
    }} imageUrl={tempImageUrl || ""} onSave={handleSaveAvatar} />

      <EmojiPickerDialog open={emojiPickerOpen} onClose={() => setEmojiPickerOpen(false)} onEmojiSelect={handleSelectEmoji} />
    </div>;
};