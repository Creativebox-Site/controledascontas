-- Update function to include investment categories
...
BEGIN
  ...
  (p_user_id, 'Tesouro Direto', 'investment', '#059669'),
  (p_user_id, 'CDB', 'investment', '#047857'),
  (p_user_id, 'LCI/LCA', 'investment', '#34d399'),
  (p_user_id, 'Debêntures', 'investment', '#6ee7b7'),
  (p_user_id, 'CRI/CRA', 'investment', '#a7f3d0');
  
  -- Renda Variável
  INSERT INTO public.categories (user_id, name, type, color) VALUES
  (p_user_id, 'Ações', 'investment', '#3b82f6'),
  (p_user_id, 'FIIs', 'investment', '#2563eb'),
  (p_user_id, 'ETFs', 'investment', '#1d4ed8'),
  (p_user_id, 'BDRs', 'investment', '#1e40af'),
  (p_user_id, 'Stocks (Exterior)', 'investment', '#1e3a8a');
  
  -- Fundos de Investimento
  INSERT INTO public.categories (user_id, name, type, color) VALUES
  (p_user_id, 'Fundo Multimercado', 'investment', '#8b5cf6'),
  (p_user_id, 'Fundo de Renda Fixa', 'investment', '#7c3aed'),
  (p_user_id, 'Fundo de Ações', 'investment', '#6d28d9'),
  (p_user_id, 'Fundo Cambial', 'investment', '#5b21b6'),
  (p_user_id, 'Fundo Imobiliário', 'investment', '#4c1d95');
  
  -- Previdência
  INSERT INTO public.categories (user_id, name, type, color) VALUES
  (p_user_id, 'PGBL', 'investment', '#f59e0b'),
  (p_user_id, 'VGBL', 'investment', '#d97706'),
  (p_user_id, 'Previdência Privada', 'investment', '#b45309');
  
  -- Criptomoedas
  INSERT INTO public.categories (user_id, name, type, color) VALUES
  (p_user_id, 'Bitcoin', 'investment', '#f97316'),
  (p_user_id, 'Ethereum', 'investment', '#ea580c'),
  (p_user_id, 'Outras Criptos', 'investment', '#c2410c');
  
  -- Outros Investimentos
  INSERT INTO public.categories (user_id, name, type, color) VALUES
  (p_user_id, 'Ouro', 'investment', '#fbbf24'),
  (p_user_id, 'Imóveis', 'investment', '#f59e0b'),
  (p_user_id, 'COE', 'investment', '#d97706'),
  (p_user_id, 'Fundos Internacionais', 'investment', '#b45309');
END;
$function$